...
import 'package:flutter_clean_arc/features/auth/domain/usecase/login/login_usecase.dart';
import 'package:flutter_clean_arc/features/auth/domain/usecase/login/login_usecase_impl.dart';
...
void main() {
  ...
  setUp(() {
    ...
    _usecase = LoginUsecaseImpl(_repository);

    _accessTokenModel = AccessTokenModel(token: 'token');
    _param = LoginParam(
